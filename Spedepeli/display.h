...
#define DATA_PIN 8 // Data input Pin
#define CLOCK_PIN 11 // Shift Register Clock Pin
#define LATCH_PIN 10 // Output Register Clock Pin
#define OE_PIN 9 //Output Enable Pin
#define CLEAR_PIN 12 // Shift Register Clear Pin
